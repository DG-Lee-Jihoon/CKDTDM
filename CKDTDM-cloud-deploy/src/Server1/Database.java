...
/**
 * Kết nối MySQL local của Server1 - bảng "server1"
 */
public class Database {

    private static final String TABLE = "server1";
    Statement stmt = null;
    ResultSet rs = null;
    Connection conn;
    ...
    public Database() {
        ...
        try {
            ...
            System.out.println("[DB-S1] Lỗi kết nối: " + ex.getMessage());
        }
    }
    ...
    public void insertData(String vitri, String bienso, String loai, String mau, String gio) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            ps.setString(5, gio);
            ps.executeUpdate();
        } catch (Exception e) { System.out.println("[DB-S1] insert: " + e.getMessage()); }
    }
    ...
    public void delData(String id) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ps.setString(1, id);
            ps.executeUpdate();
        } catch (Exception e) { System.out.println("[DB-S1] delete: " + e.getMessage()); }
    }
    ...
    public boolean querySQL(String vitri, String bienso, String hieu, String mau) {
        try {
            ...
            rs = ps.executeQuery();
            return !rs.next(); // true = chưa có → cho phép insert
        } catch (Exception e) { return true; }
    }
}
