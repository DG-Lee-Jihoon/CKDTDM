...
public class Database {
    ...
    private static final String TABLE = "server3";
    Statement stmt = null;
    ResultSet rs = null;
    Connection conn;
    ...
    public Database() {
        ...
        try {
            ...
            System.out.println("[DB-S3] Lỗi kết nối: " + ex.getMessage());
        }
    }
    ...
    public void insertData(String vitri, String bienso, String loai, String mau, String gio) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            ps.setString(5, gio);
            ps.executeUpdate();
        } catch (Exception e) { System.out.println("[DB-S3] insert: " + e.getMessage()); }
    }
    ...
    public void delData(String id) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ps.setString(1, id);
            ps.executeUpdate();
        } catch (Exception e) { System.out.println("[DB-S3] delete: " + e.getMessage()); }
    }
