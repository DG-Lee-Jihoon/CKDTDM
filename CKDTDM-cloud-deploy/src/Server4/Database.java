...
public class Database {
    ...
    private static final String TABLE = "server4";
    Statement stmt = null;
    ResultSet rs = null;
    Connection conn;
    ...
    public Database() {
        ...
        try {
            ...
            System.out.println("[DB-S4] Lỗi kết nối: " + ex.getMessage());
        }
    }
    ...
    public void insertData(String vitri, String bienso, String loai, String mau, String gio) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            ps.setString(5, gio);
            ps.executeUpdate();
        } catch (Exception e) { System.out.println("[DB-S4] insert: " + e.getMessage()); }
    }
    ...
    public void delData(String id) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ps.setString(1, id);
            ps.executeUpdate();
        } catch (Exception e) { System.out.println("[DB-S4] delete: " + e.getMessage()); }
    }
